...
public class HobbyistUser extends User{
	...
	public HobbyistUser(String nickname, String password, String name, String surname, String age, String mailAddress,
	...
	public ArrayList<String> getPrivileges() {
		return new ArrayList<>(Arrays.asList("blur", "sharpen", "brightness", "contrast"));
	}
	@Override
